module "alarm_channel" {
  count       = true ? 1 : 0
  source      = "github.com/massdriver-cloud/terraform-modules//k8s/alarm-channel?ref=3ba41fe"
...
module "application_alarms" {
  count             = true ? 1 : 0
  source            = "github.com/massdriver-cloud/terraform-modules//massdriver/k8s-application-alarms?ref=3ba41fe"
  md_metadata       = var.md_metadata
  pod_alarms        = true
...
module "cluster_autoscaler_max_scale" {
  count                 = true ? 1 : 0
  source                = "github.com/massdriver-cloud/terraform-modules//k8s/prometheus-alarm?ref=3ba41fe"
  md_metadata           = var.md_metadata
